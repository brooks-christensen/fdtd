...
plt.figure(); plt.plot(t, E_probe); plt.xlabel("time t (ps)"); plt.ylabel("E-field (a.u.)"); plt.title("PMC @ RB, MTS")
plt.savefig("outputs/fig03_pmc_mts_E.png", dpi=200, bbox_inches="tight"); plt.close()
plt.figure(); plt.plot(t, B_probe); plt.xlabel("time t (ps)"); plt.ylabel("B-field (a.u.)"); plt.title("PMC @ RB, MTS")
plt.savefig("outputs/fig03_pmc_mts_B.png", dpi=200, bbox_inches="tight"); plt.close()

print("Wrote outputs/fig03_pmc_mts_E.png and fig03_pmc_mts_B.png")
