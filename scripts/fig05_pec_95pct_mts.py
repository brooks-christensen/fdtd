...
plt.figure(); plt.plot(t, E_probe); plt.xlabel("time t (ps)"); plt.ylabel("E-field (a.u.)"); plt.title("PEC @ RB, 95% of MTS")
plt.savefig("outputs/fig05_pec_95pct_mts_E.png", dpi=200, bbox_inches="tight"); plt.close()
plt.figure(); plt.plot(t, B_probe); plt.xlabel("time t (ps)"); plt.ylabel("B-field (a.u.)"); plt.title("PEC @ RB, 95% of MTS")
plt.savefig("outputs/fig05_pec_95pct_mts_B.png", dpi=200, bbox_inches="tight"); plt.close()
print("Wrote outputs/fig05_pec_95pct_mts_E.png and fig05_pec_95pct_mts_B.png")
